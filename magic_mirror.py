...
def open_spotify_window(event):
    ...
    get_map = requests.urlopen('https://maps.googleapis.com/maps/api/staticmap?center=Trondheim, Norway&zoom=11&size=600x300&maptype=roadmap&key=AIzaSyD6B7E-AxXFmEPU7nF2sEJtqO2g9eRZuPQ'.read())
